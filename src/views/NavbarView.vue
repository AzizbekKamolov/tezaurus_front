<template>
    <!-- component -->
	<nav class="relative px-4 py-4 flex justify-between items-center bg-white drop-shadow-xl">
		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
			<li>
                <RouterLink class="text-sm text-gray-400 hover:text-gray-500" :to="{name:'home'}">Home</RouterLink>
            </li>
        ...
        <RouterLink :to="{name:'login'}" class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"><i class="fas fa-user fa-2x"></i></RouterLink>
