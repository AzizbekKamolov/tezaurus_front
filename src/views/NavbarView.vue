<template>
  <!-- component -->
  <nav
    class="relative px-4 py-4 flex justify-between items-center bg-white drop-shadow-xl"
  >
    ...
    >
      ...
      <li>
        <a class="text-sm text-gray-400 hover:text-gray-500" href="#">Forum</a>
      </li>
    </ul>
	<template v-if="isLoggedIn">
		<RouterLink
      :to="{ name: 'home' }"
      class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 text-sm text-gray-900 font-bold rounded-xl transition duration-200"
